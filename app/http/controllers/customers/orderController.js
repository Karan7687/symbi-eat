  ...
  return {
    ...
    async store(req, res) {
      try {
        ...
        for (const itemId in cart.items) {
          ...
          try {
            ...
            if (menuItem && menuItem.preparationTime) {
              ...
              console.log(
                "Found menu item prep time from DB:",
                menuItem.name,
                "-",
                itemPrepTime,
              );
          ...
          console.log(
            "Item total time (prep time x quantity):",
            itemTotalTime,
            "Running total:",
        ...
        console.log(
          "Final preparation time calculated:",
          totalPreparationTime,
          "minutes",
        );
        ...
        const estimatedDeliveryTime = new Date(
          Date.now() + totalPreparationTime * 60 * 1000,
        );
        ...
        console.log(
          "Passing preparationTime to template:",
          totalPreparationTime,
        );
    ...
    // show: return order data as JSON for API
    async show(req, res) {
      try {
